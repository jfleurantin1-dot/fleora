...
export default async function VendorNetworkThread(props:{params: Promise<{conversationId:string}>}) {
 const params = await props.params;
 const {profile,vendor}=await requireVendor();if(!vendor)notFound();const s=await createClient();
