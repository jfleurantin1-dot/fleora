  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-ivory-50 px-5 py-10 sm:px-6">
      <div className="relative mx-auto max-w-5xl">
        <div className="flex items-center justify-between"><BrandLogo /><Link href="/login" className="text-sm font-semibold text-plum-700 hover:underline">Log in</Link></div>
        <div className="mx-auto mt-8 grid max-w-4xl gap-10 lg:grid-cols-[1fr_.9fr] lg:items-center">
          <section>
            <p className="fleora-kicker">Customer pre-launch</p>
            <h1 className="mt-3 font-display text-5xl leading-[1.12] text-ink-900 sm:text-5xl">Your next event is about to get a lot easier.</h1>
