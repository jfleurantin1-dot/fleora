...
-- =====================================================================
-- 0006_vendor_directory_claims.sql
-- =====================================================================
...
create policy "vendors: admin insert" on vendors for insert to authenticated with check (is_admin());
create policy "vendor_categories: admin write" on vendor_categories for all to authenticated using (is_admin()) with check (is_admin());
create policy "vendor_photos: admin write" on vendor_photos for all to authenticated using (is_admin()) with check (is_admin());
create policy "services: admin write" on services for all to authenticated using (is_admin()) with check (is_admin());
create policy "packages: admin write" on packages for all to authenticated using (is_admin()) with check (is_admin());
create policy "vendor_claims: claimant read own" on vendor_claims for select to authenticated using (claimant_id = auth.uid() or is_admin());
create policy "vendor_claims: claimant create" on vendor_claims for insert to authenticated with check (claimant_id = auth.uid());
create policy "vendor_claims: admin update" on vendor_claims for update to authenticated using (is_admin()) with check (is_admin());
