...
insert into vendor_categories (vendor_id, category) values
  ...
  ('b0000001-0000-0000-0000-000000000001','backdrops'),
  ('b0000002-0000-0000-0000-000000000002','cake'),
  ('b0000002-0000-0000-0000-000000000002','cupcakes'),
  ('b0000002-0000-0000-0000-000000000002','cookies'),
  ('b0000003-0000-0000-0000-000000000003','catering'),
  ('b0000003-0000-0000-0000-000000000003','private_chef'),
  ('b0000003-0000-0000-0000-000000000003','charcuterie'),
  ('b0000003-0000-0000-0000-000000000003','bartender'),
  ('b0000004-0000-0000-0000-000000000004','chairs'),
  ('b0000004-0000-0000-0000-000000000004','tables'),
  ('b0000004-0000-0000-0000-000000000004','linens'),
  ...
  ('b0000007-0000-0000-0000-000000000007','flower_walls'),
  ('b0000008-0000-0000-0000-000000000008','bartender'),
  ('b0000009-0000-0000-0000-000000000009','backdrops');
...
insert into services (vendor_id, category, name, description, starting_price) values
  ('b0000001-0000-0000-0000-000000000001','balloons','Organic balloon garland','8ft garland in your palette, delivered and installed', 450),
  ('b0000001-0000-0000-0000-000000000001','backdrops','Backdrop + garland package','Circle or shimmer-wall backdrop with a full garland and signage ledge', 850),
  ...
  ('b0000002-0000-0000-0000-000000000002','cupcakes','Cupcake tower','Two dozen, two flavors, styled to your theme', 90),
  ('b0000002-0000-0000-0000-000000000002','cookies','Custom iced cookies','Per dozen, hand-decorated', 48),
  ...
  ('b0000003-0000-0000-0000-000000000003','private_chef','Private chef dinner','On-site multi-course dinner for up to 12', 900),
  ('b0000003-0000-0000-0000-000000000003','charcuterie','Grazing table','8ft styled grazing table for 50', 550),
  ('b0000003-0000-0000-0000-000000000003','bartender','Bar staffing add-on','Two bartenders for 4 hours', 520),
  ('b0000004-0000-0000-0000-000000000004','tables','Tables — per 50 guests','Rounds or banquets, delivered and set', 200),
  ('b0000004-0000-0000-0000-000000000004','chairs','Chairs — per 50 guests','Chiavari or crossback, delivered and set', 175),
  ('b0000004-0000-0000-0000-000000000004','linens','Linens — per 50 guests','Floor-length cloths and napkins, pressed', 160),
  ...
  ('b0000007-0000-0000-0000-000000000007','flower_walls','Flower wall','8x8 backdrop wall, silk or fresh, delivery + install + strike', 650),
  ...
  ('b0000009-0000-0000-0000-000000000009','backdrops','Custom signage suite','Welcome sign, bar menu, table numbers', 260);
...
values
  ('c0000000-0000-0000-0000-0000000000a1','e0000000-0000-0000-0000-0000000000ff','b0000001-0000-0000-0000-000000000001','backdrops','accepted',850,300,850),
...
insert into bookings (id, event_id, vendor_id, quote_id, category, status, total, deposit_paid, balance) values
  ('d0000000-0000-0000-0000-0000000000a1','e0000000-0000-0000-0000-0000000000ff','b0000001-0000-0000-0000-000000000001','c0000000-0000-0000-0000-0000000000a1','backdrops','completed',850,850,0),
...
insert into quotes (id, event_id, vendor_id, category, status, subtotal, deposit, total) values
  ...
  ('c0000000-0000-0000-0000-0000000000b2','e0000000-0000-0000-0000-0000000000fe','b0000004-0000-0000-0000-000000000004','tables','accepted',720,250,720),
...
insert into bookings (id, event_id, vendor_id, quote_id, category, status, total, deposit_paid, balance) values
  ...
  ('d0000000-0000-0000-0000-0000000000b2','e0000000-0000-0000-0000-0000000000fe','b0000004-0000-0000-0000-000000000004','c0000000-0000-0000-0000-0000000000b2','tables','completed',720,720,0),
...
insert into event_requests (event_id, category, status) values
  ('e1111111-1111-1111-1111-111111111111','balloons','open'),
  ('e1111111-1111-1111-1111-111111111111','backdrops','open'),
  ('e1111111-1111-1111-1111-111111111111','cake','open'),
  ('e1111111-1111-1111-1111-111111111111','cupcakes','open'),
